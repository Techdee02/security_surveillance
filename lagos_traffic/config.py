...
CONFIDENCE_THRESHOLD = 0.30  # Standard threshold for vehicles
MOTORCYCLE_CONFIDENCE = 0.30  # Same as other vehicles to reduce false positives
INPUT_SIZE = 640  # Larger input for better small object (motorcycle) detection
DEVICE = "cpu"  # or "cuda" if GPU available

# Performance settings
PROCESSING_WIDTH = 800  # Higher resolution for better motorcycle detection
STREAM_WIDTH = 960  # Resize for streaming (lower bandwidth)
SKIP_FRAMES = 2  # Process every 3rd frame (better for fast-moving okadas)
...
# Additional classes to help detect motorcycles
# Person (class 0) riding motorcycle helps identify okadas
PERSON_CLASS_ID = 0
MOTORCYCLE_CLASS_ID = 3

# Okada detection enhancement settings
OKADA_MIN_WIDTH = 20  # Minimum width in pixels
OKADA_MAX_WIDTH = 250  # Maximum width (okadas are small)
OKADA_PERSON_OVERLAP_THRESHOLD = 0.3  # IoU threshold for person-motorcycle association
